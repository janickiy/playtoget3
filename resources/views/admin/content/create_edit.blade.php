            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <header class="card card-primary">
                        ...
                        <!-- form start -->
                        {!! Form::open(['url' => isset($row) ? route('admin.content.update') : route('admin.content.store'), 'method' => isset($row) ? 'put' : 'post']) !!}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('title', old('title', $row->title ?? null), ['id' => 'title', 'title' => 'title', 'class' => 'form-control']) !!}
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                {!! Form::label('slug', 'ЧПУ') !!}
                                {!! Form::text('slug', old('slug', $row->slug ?? null), ['id' => 'slug', 'title' => 'slug', 'class' => 'form-control']) !!}
                                @if ($errors->has('slug'))
                                    <p class="text-danger">{{ $errors->first('slug') }}</p>
                                @endif
                            </div>

                            <div class="form-group content-text-field">
