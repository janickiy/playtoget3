    ...
    <div class="photo_big_wrap">
        ...
        <div class="text video-modal-comment-form">
            <form autocomplete="off" id="addCommentForm" class="form-horizontal" method="POST" action="">
                ...
                @if ($viewer)
                    <label class="video-modal-comment-title" for="video_comment">Оставить комментарий</label>
                ...
                @else
                    <div class="video-modal-login-note">Чтобы оставить комментарий авторизуйтесь</div>
                @endif
            </form>
        </div>
        </div>
