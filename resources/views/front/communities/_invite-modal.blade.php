    ...
    @push('scripts')
        <script>
            (function () {
                ...
                const $modal = $('.js-community-invite-modal');
                const $content = $modal.find('.js-community-invite-content');
                const $status = $modal.find('.js-community-invite-status');
                const $submit = $modal.find('.js-community-invite-submit');
                ...
                $(document).on('change', '.js-community-invite-check', syncSubmit);

                $(document).on('click', '.js-community-invite-close', closeModal);
                ...
                $(document).on('click', '.js-community-invite-submit', function () {
                    const communityId = $modal.data('community-id');
                    const userIds = selectedIds();

                    if (!communityId || userIds.length === 0 || $submit.data('loading') === 1) {
                        return;
                    }
