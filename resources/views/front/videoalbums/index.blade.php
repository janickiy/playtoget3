    ...
    @else
        @if ($canManage)
            <div class="add-photos-album">
                <span><i class="videoicon"></i><a href="{{ route('front.videoalbums.add-video') }}">Добавить видео</a></span>
                <span>или</span>
                <span><i></i><a href="{{ route('front.videoalbums.create') }}">Создать видеоальбом</a></span>
            </div>
        @endif
