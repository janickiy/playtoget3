<div class="community-invite-modal js-event-invite-modal" aria-hidden="true">
    <div class="community-invite-modal-dialog">
        <button type="button" class="community-invite-close js-event-invite-close" aria-label="Close">×</button>
        <h3>Invite friends</h3>
        <div class="community-invite-status js-event-invite-status">Loading...</div>
        <div class="community-invite-content js-event-invite-content"></div>
        <div class="community-invite-footer">
            <button type="button" class="community-invite-submit js-event-invite-submit" disabled>Send invitation</button>
        </div>
    </div>
</div>
        ...
        <script>
            (function () {
                ...
                window.openEventInviteModal = function (eventId) {
                    ...
                    $content.empty();
                    $status.text('Loading...');
                    $submit.prop('disabled', true).data('loading', 0).text('Send invitation');
