...
<div class='overlay' id='photo_big'>
  ...
  <div class='photo_big_wrap'>
    ...
    <div class="loading-bar"><img border="0" src="./frontend/images/select2-spinner.gif"></div>
    <div class="text">
      <div class="message">
    ...
    <div class="text">
      <form autocomplete="off" id="addCommentForm" class="form-horizontal" method="POST" action="">
        ...
        <div class="form-group">
          ...
          <div class="smile-files"> <a id="smilesBtn" class="smile smilesBtn" data-num="0"><img src="./frontend/images/smile.png" alt=""></a> <a href="#" class="files" data-num="0"><img src="./frontend/images/files.png" alt=""></a> </div>
