				...
				<div class="row">
					<div class="col-md-7 section-sport-inside margin_none">
						...
						<div class="container header-entrance margin_none">
							<div class="row">
								<div class="col-xs-12">
									<a href="./" class="entrance-logo"><img borde="0" src="./frontend/images/logo-main.png" alt="playtoget-logo"></a>
