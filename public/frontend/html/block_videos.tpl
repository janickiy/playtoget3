...
<div class="photo-container video-container vid-no-border">
  ...
  <!-- IF '${ALLOW_EDIT}' != '' --><span class="icons-hid"><i id="my-video-${ID}" class="remove_video" data-item="${ID}" data-tooltip="${STR_REMOVE_VIDEO}"><img src="./frontend/images/icon-krest.png" alt=""></i></span><!-- END IF --> 
