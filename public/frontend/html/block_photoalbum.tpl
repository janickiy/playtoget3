...
<div class="photo-container my-photos">
  ...
  <div class="hov" id="photo-block-${ID_PHOTO}"> 
  	...
  	<!-- IF '${ALLOW_EDIT}' == 'show' --><span class="icons-hid"><i id="my-video-${ID_PHOTO}" class="remove_pic" id="${ID_PHOTO}" data-item="${ID_PHOTO}" data-tooltip="${STR_REMOVE_PHOTO}"><img src="frontend/images/icon-krest.png" alt=""></i></span><!-- END IF --> 
  </div>
  <!-- END IF -->
