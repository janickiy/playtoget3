...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 * previous, first or last content.
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of content of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} content` The number of content in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, content ) {
